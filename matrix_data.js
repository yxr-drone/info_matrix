const matrixData = [
  ...
  },
  {
    ...
    "translation": "因其在 AI 领域的变革性贡献，特别是创立了催化深度学习革命的 ImageNet，李飞飞教授荣获 2025 年伊丽莎白女王工程奖。",
  ...
  },
  {
    ...
    "translation": "Karpathy 发布了 microgpt：仅用 200 行纯 Python 代码（零依赖）实现了从零训练到推理 GPT 的全流程。这是对神经网络极简主义的致敬，他称其为“美丽的艺术项目”🥹。",
  ...
  },
  {
    ...
    "title": "深度神经网络：33 年前与 33 年后",
    "original": "LeCun et al. 1989 is the earliest real-world application of a neural net trained end-to-end with backpropagation. Can we improve on it using 33 years of progress? What will today's deep learning look like to someone in 2055?",
    "translation": "回顾 LeCun 1989 年的经典论文——最早通过反向传播进行端到端训练的神经网络应用。Karpathy 探讨了 33 年来的技术飞跃，并预言当 2055 年的人们回望今日，深度学习会呈现出怎样的面貌。",
  ...
  },
  {
    ...
    "translation": "本文介绍如何仅使用纯 Python、不依赖任何库，从零开始创建、数字签名并广播一笔比特币交易。这是理解区块链底层细节的最佳实践教程。",
  ...
  },
  {
    ...
    "title": "训练神经网络的实战秘籍 (Recipe)",
    "original": "A collection of practical advice for the process of achieving strong results with neural networks. Training a neural net is a leaky abstraction.",
    "translation": "Karpathy 总结的一套训练神经网络的实用法则。他指出训练神经网络是一种“带漏洞的抽象”，并分享了许多从实验到交付的宝贵经验。",
  ...
  },
  {
    "author": "Andrej Karpathy",
    "date": "May 21, 2015",
    "id": "ak_2015_05_21_rnn_effectiveness",
    "title": "循环神经网络 (RNN) 的惊人成效",
    "original": "A review of Recurrent Neural Networks which learn to write poetry, latex math and code. Analyzing models to get hints of future research directions.",
    "translation": "这篇文章探讨了循环神经网络 (RNN) 如何通过学习编写诗歌、LaTeX 公式和代码展现出惊人的生成能力，并以此分析未来研究的走向。",
