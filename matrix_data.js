const matrixData = [
  ...
  },
  {
    ...
    "translation": "OpenAI 宣布 Sora 迎来重大更新：现已支持全 4K 分辨率生成，并显著增强了生成视频中的物理一致性（如流体动力学和光影追踪）。",
  ...
  },
  {
    ...
    "isHot": true,
    "original": "Sam Altman discusses the critical need for global energy infrastructure to support the next generation of planetary-scale computing.",
    "translation": "Sam Altman 撰文探讨了全球能源基础设施建设的紧迫性。他指出，算力已成为国家主权的核心，而充足的能源供应将是实现行星级 AI 计算的关键瓶颈。",
    "url": "https://blog.samaltman.com/"
  },
  {
    "author": "Fei-Fei Li",
    ...
    "isHot": true,
    "original": "Recognized for her transformative contributions to computer vision and AI through the creation of ImageNet.",
    "translation": "李飞飞教授荣获伊丽莎白女王工程奖，以表彰她通过 ImageNet 为计算机视觉和现代 AI 奠定的基石性贡献。",
    "url": "https://profiles.stanford.edu/fei-fei-li"
  },
  {
    "author": "Andrej Karpathy",
    "date": "Feb 12, 2026",
    "id": "ak_microgpt",
    "title": "microgpt: 200 行 Python 实现完整 GPT",
    "isHot": true,
    "original": "A beautiful 200-line implementation of a GPT model from scratch in pure Python.",
    "translation": "Karpathy 展示了如何用仅 200 行纯 Python 代码（无外部依赖）完成 GPT 的训练与推理。这是目前最适合理解大模型架构的极简模本。",
    "url": "https://karpathy.github.io/2026/02/12/microgpt/"
  }
];